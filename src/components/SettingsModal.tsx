...
import { X, Globe, User, Cloud, CloudOff, LogOut, Check } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-surface-800 border border-surface-600/50 rounded-2xl w-full max-w-md max-h-[80vh] overflow-hidden animate-fade-in">
              ...
              {user ? (
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    disabled={authLoading}
                    className="w-full py-3 rounded-xl bg-surface-700 hover:bg-surface-600 text-muted hover:text-white text-sm font-medium flex items-center justify-center gap-2 transition-colors"
                  >
                    <User size={16} />
                    {t.auth_sign_in_anonymous}
                  </button>
                  <p className="text-[10px] text-muted-dark text-center px-2">
          ...
          {!isConfigured && (
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-3">
              <p className="text-xs text-yellow-400/80">
                <strong>Cloud sync not configured.</strong><br />
                Data is stored locally in your browser. To enable cloud sync, configure Firebase.
              </p>
            </div>
          )}
        </div>
        ...
        {/* Footer */}
        <div className="px-4 py-3 border-t border-surface-600/50 text-center">
          <p className="text-[10px] text-muted-dark">
            {t.credits}{' '}
            <a href="mailto:noemi.marcolini@gmail.com" className="text-muted hover:text-white underline">
              Noemi Marcolini
            </a>
          </p>
        </div>
